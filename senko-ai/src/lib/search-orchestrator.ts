...
const FALLBACK_CASCADE: FallbackLevel[] = [
  ...
  { level: 3, name: "google-scrape", fn: searchGoogleScrape, errorCodePrefix: "GOOGLE" },
  { level: 4, name: "serper",        fn: searchSerper,        errorCodePrefix: "SERPER" },
  { level: 5, name: "puppeteer",     fn: searchPuppeteer,     errorCodePrefix: "PUPPETEER" },
];
