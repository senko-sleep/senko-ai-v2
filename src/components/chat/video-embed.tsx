...
const NEEDS_PROXY_PATTERN = /\b(xvideos|pornhub|xhamster|redtube|tube8|spankbang|xnxx|youporn|eporner|tnaflix|rule34video|hentaihaven|hanime|iwara|spankwire|xtube|thumbzilla|keezmovies|boomio-cdn|remote_control)\b/i;
    ...
    <div className="overflow-hidden rounded-2xl border border-white/[0.1] bg-black/40 shadow-xl">
      {state === "failed" ? (
        <a
          ...
          className="flex items-center justify-center gap-2.5 py-12 px-4 text-sm text-zinc-400 hover:text-[var(--senko-accent)] transition-colors"
        >
